  ...
  <body>
	...
	<div class="col-lg-3">
     ...
     <div class="row">
		...
		<hr />
		<button class="btn btn-lg btn-block btn-primary" type="submit">Submit Advertisement</button>
	</form>
		<hr />
...
if($saved === true){
	echo '<br /><a class="btn btn-lg btn-success" href="/adreview.php" role="button">Review Matching Pages</a>';
	$arr= array();
